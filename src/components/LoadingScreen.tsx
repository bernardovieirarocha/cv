...
const LoadingScreen = ({ isLoading }: LoadingScreenProps) => {
    ...
    return (
        <div
            className={`fixed inset-0 z-[100] hidden md:flex items-center justify-center bg-background transition-opacity duration-500 ${isLoading ? 'opacity-100' : 'opacity-0 pointer-events-none'
                }`}
        >
